...
public class LeaderboardManagement : MonoBehaviour
{
    ...
    private string world = "SE";
    private readonly string backendurl = "http://localhost:9090/api/world/getLeaderBoard/";
    ...
    IEnumerator getLeaderboard(string category)
    {
        ...
        //backendurl = "http://localhost:9090/api/world/getLeaderBoard/";
        ...
        string jsonString_SA = PlayerPrefs.GetString("SA");
